...
@Component({
  selector: 'app-vm-downlink-traffic-utilization',
  templateUrl: './vm-downlink-traffic-utilization.component.html',
  styleUrls: ['./vm-downlink-traffic-utilization.component.css']
})
export class VmDownlinkTrafficUtilizationComponent implements OnInit, OnDestroy, OnChanges {
  @Input() vmName: string;
  @Input() scale: string;
  @Input() range: string;
  ...
  drawGraph(scaleVal) {
    console.log('draw graph method fired of traffic ', this.vmName);
