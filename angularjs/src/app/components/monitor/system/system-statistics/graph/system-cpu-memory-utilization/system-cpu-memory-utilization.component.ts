...
@Component({
  selector: 'app-system-cpu-memory-utilization',
  templateUrl: './system-cpu-memory-utilization.component.html',
  styleUrls: ['./system-cpu-memory-utilization.component.css']
})
export class SystemCpuMemoryUtilizationComponent implements OnInit, OnChanges, OnDestroy {
