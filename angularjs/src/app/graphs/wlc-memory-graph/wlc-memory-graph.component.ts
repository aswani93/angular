...
@Component({
  selector: 'app-wlc-memory-graph',
  templateUrl: './wlc-memory-graph.component.html',
  styleUrls: ['./wlc-memory-graph.component.css']
})
export class WlcMemoryGraphComponent implements OnInit, OnChanges, OnDestroy {
