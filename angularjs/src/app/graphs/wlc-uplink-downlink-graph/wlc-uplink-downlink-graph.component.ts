...
@Component({
  selector: 'app-wlc-uplink-downlink-graph',
  templateUrl: './wlc-uplink-downlink-graph.component.html',
  styleUrls: ['./wlc-uplink-downlink-graph.component.css']
})
export class WlcUplinkDownlinkGraphComponent implements OnInit, OnDestroy, OnChanges {
